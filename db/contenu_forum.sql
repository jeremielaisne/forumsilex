...
(2, 1, 'Actu - News', 'Les nouveautés c est par ici', 50, 0, 0, 0, 0, 0, 0, 0, 0),
(3, 1, 'Discussions générales', 'Ici on peut parler de tout sur tous les sujets', 40, 0, 0, 0, 0, 0, 0, 0, 0),
(4, 2, 'Platformer', 'Nouveau Mario, Rayman ou Prince of Persia ', 60, 0, 0, 0, 0, 0, 0, 0, 0),
(5, 2, 'RPG', 'Pour les fans de zelda, de final fantasy ou de Kingdom s Heart c est ici', 50, 0, 0, 0, 0, 0, 0, 0, 0),
(6, 3, 'Random', 'Casse-briques', 60, 0, 0, 0, 0, 0, 0, 0, 0),
(7, 3, 'Projets', 'Une nouvelle version du forum en Silex 2.0 en préparation avec du JS en plus', 50, 0, 0, 0, 0, 0, 0, 0, 0);
